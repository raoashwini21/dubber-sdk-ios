#import "DUBConfiguration.h"

@interface DUBConfiguration ()
...
@implementation DUBConfiguration

#pragma mark - Singletion Methods

+ (instancetype) sharedConfig {
    static DUBConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        self.apiClient = nil;
        self.host = @"https://api.dubber.net/ci";
        self.username = @"";
        self.password = @"";
