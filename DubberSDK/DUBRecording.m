...
{
  NSArray *optionalProperties = @[@"_id", @"toLabel", @"fromLabel", @"status", @"transfers", @"additionalParties", @"duration", @"recordingType", @"channel", @"endTime", @"tags", @"metadata", @"metaTags", @"dateCreated", @"dateUpdated"];
